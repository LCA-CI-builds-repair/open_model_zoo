 ...
 * Version 3.0.12
 *
 * This file is not intended to be easily readable and contains a       // success code
     } else {
       // fail code
     }

   // Now you can be more explicit:
    int res = SWIG_ConvertPtr(obj, vptr, ty.flags);of
...
/*
  Check type equivale *  1) If the cast->type has already been loaded AND the type we are adding
 *     casting info to has not been loaded (it is in this module), THEN we
 *     replace the cast->type pointer with the type pointer that has already
 *     been loaded.in a name list like <name1>|<name2>|...
