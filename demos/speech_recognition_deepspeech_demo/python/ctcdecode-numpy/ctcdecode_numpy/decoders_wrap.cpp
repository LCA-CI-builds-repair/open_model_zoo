 ...
 * Version 3.0.12
 *
 * This file is not intended to be easily readable and contains a number o      // Success code
    } else {
      // Failure code and error handling
...
#   define SWIGINLINE inl        if (!newmemory) {
            // Handle newmemory not implemented
        } else {e
# else
#   define SWIGINLINE
# endif
