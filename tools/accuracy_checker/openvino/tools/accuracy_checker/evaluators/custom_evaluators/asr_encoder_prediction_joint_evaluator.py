...
distributed under the Licenseclass ASREncoderPredictionJointEvaluator:
    # Implement the functionality for ASR encoder prediction joint evaluator
    pass

class JointONNXModel(CommonONNXModel):
    # Implement the functionality for Joint ONNX Model
    passistributed on an "AS IS" BASIS,
